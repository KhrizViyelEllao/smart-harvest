...
document.getElementById('profileForm').addEventListener('submit', async e=>{
  ...
  if (!payload.name || !payload.email) { err.textContent='Name and Email required.'; err.classList.remove('d-none'); return; }
  if (payload.new_password && payload.new_password.length < 6) { err.textContent='New password too short.'; err.classList.remove('d-none'); return; }
  try {
